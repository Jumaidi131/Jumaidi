...
<div class="box">
	<h1><img src="../img/obat.png" width="60px"></style> Obat</h1>
					...
					while ($data = mysqli_fetch_array($sql_obat)) { ?>
						<tr>
							...
							<td class="text-center">
								...
								<a href="del.php?id=<?=$data['id_obat']?>" onclick="return confirm('Anda Yakin Menghapus Data?')" class="btn btn-danger btn-xs"><i class="glyphicon glyphicon-trash"></i></a>
							</td>
						</tr>
					<?php
					}
